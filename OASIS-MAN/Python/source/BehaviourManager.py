...
class BehaviourManager:
    def __init__(self, ontologyGraph, ontologyNamespace, ontologyURL,
        ...
        #oasis ontology data
        #
        self.addOntoMap("oasis", "https://www.dmi.unict.it/santamaria/projects/oasis/sources/v2/oasis-2.owl", None, 0)  # OASIS ontology object
        self.ontologies[self.ontoMap["oasis"]["onto"]]=self.loadOntology(self.ontoMap["oasis"]["url"])
        self.addOntoMap("abox", "https://www.dmi.unict.it/santamaria/projects/oasis/sources/v2/oasis-abox-2.owl", None, 1)  # OASIS-ABox ontology object
